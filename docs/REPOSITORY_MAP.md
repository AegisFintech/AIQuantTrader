...
The action plan inherits that exact expiry, deterministically maps every target
to its safe stage and required typed outcome evidence, requires an operator
ledger, and contains no command or execution capability.
