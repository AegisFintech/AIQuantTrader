...
from aiquanttrader.release_manifest import load_release_manifest
...
def load_status_bidask(common_dir: Path) -> list[dict]:
    """Read aiquanttrader_status.json and return one bid/ask snapshot per symbol."""
    status_path = Path(common_dir) / "aiquanttrader_status.json"
