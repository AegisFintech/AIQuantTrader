...
from aiquanttrader import data_store, validators
...
def compute_snapshot(
    *,
    ...
    status_path = common_dir / "aiquanttrader_status.json" if common_dir is not None else None
...
def get_pm2_restarts(process_name: str = "aiquanttrader-mt5") -> int | None:
