...
import aiquanttrader.retirement.action_plan as action_plan_module
import aiquanttrader.retirement.cleanup as cleanup_module
import aiquanttrader.retirement.closeout as closeout_module
import aiquanttrader.retirement.outcome as outcome_module
import aiquanttrader.retirement.preflight as preflight_module
...
from aiquanttrader.retirement.evidence import load_retirement_policy
...
def test_cleanup_manifest_is_assembled_from_exact_replayable_evidence(
    ...
    monkeypatch.setattr("aiquanttrader.retirement.cleanup.time_ns", lambda: now_ns)
...
def test_cleanup_cli_assembles_and_independently_replays_bundle(
    ...
    monkeypatch.setattr("aiquanttrader.retirement.cleanup.time_ns", lambda: now_ns)
    monkeypatch.setattr(
        "aiquanttrader.retirement.cli._replay_cleanup_sources",
