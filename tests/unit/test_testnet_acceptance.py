...
from aiquanttrader.acceptance.cli import main as acceptance_main
...
from aiquanttrader.governance.models import TestnetLifecycleScenario as LifecycleScenario
...
def test_operational_log_rejects_unsafe_or_incomplete_storage(
    ...
    monkeypatch.setattr("aiquanttrader.acceptance.audit.MAX_AUDIT_BYTES", 1)
...
def test_acceptance_models_reject_invalid_final_facts_and_events() -> None:
    ...
    from aiquanttrader.acceptance.models import OperationalEvidenceEvent
