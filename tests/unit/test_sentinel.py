...
from aiquanttrader.acceptance.audit import (
...
from aiquanttrader.sentinel.metrics import SentinelMetrics
from aiquanttrader.sentinel.service import HyperliquidControlClient, SafetySentinel
...
def test_control_client_validates_open_orders_and_exchange_responses(
    ...
    monkeypatch.setattr("aiquanttrader.sentinel.service.Account.from_key", Mock())
    monkeypatch.setattr("aiquanttrader.sentinel.service.Info", Mock(return_value=info))
    monkeypatch.setattr("aiquanttrader.sentinel.service.Exchange", Mock(return_value=exchange))
