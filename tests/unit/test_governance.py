...
from aiquanttrader.domain.governance import (
    ActorKind,
    DeploymentApproval,
    PromotionStage,
...
def approval(**overrides: object) -> DeploymentApproval:
    ...
    values: dict[str, object] = {
        ...
        "trading_wallet_address": "0x" + "2" * 40,
        "control_wallet_address": "0x" + "3" * 40,
        "commit_sha": "b" * 40,
        ...
        "shadow_evidence_sha256": HASH,
        "testnet_evidence_sha256": HASH,
