...
from aiquanttrader_native.execution.secrets import PrivateKey, read_private_key
...
def test_heartbeat_publishes_health_and_operator_kill(
    ...
    monkeypatch.setattr("aiquanttrader_native.execution.heartbeat.time.time_ns", lambda: 100)
