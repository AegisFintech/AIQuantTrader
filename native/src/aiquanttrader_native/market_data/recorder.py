...
from aiquanttrader_native.config.models import MarketDataConfig
from aiquanttrader_native.domain.data import RecorderState, SegmentFinalizationReason
...
def _subscriptions(channels: Sequence[str]) -> tuple[str, ...]:
    from aiquanttrader_native.market_data.protocol import subscription_messages
